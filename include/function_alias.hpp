...
namespace stardec {
    ...
    using belief_function = std::function<belief(const argument &arg)>;
    using filter_function = std::function<bool(const argument* const candidate, const std::vector<argument*> &sequence)>;
